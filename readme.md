Bilkul. Problem ye tha ki tumhare Markdown mein **`#`, `**`, `<p>`, `<img>`, URLs aur code fences unnecessarily escape/mangle ho gaye the**, isliye GitHub par code jaisa dikh raha tha.

Neeche **ONE SINGLE FULL MARKDOWN CODE BLOCK** hai. Isko exactly copy karke `README.md` mein paste karo. Maine formatting clean rakhi hai, aur internal Mermaid/Python code blocks bhi properly work karenge.
...
- [Visual Gallery](#️-visual-gallery)
...
Decision-tree-based regression is explored for predicting continuous outcomes.
...
Density-based clustering for discovering groups of arbitrary shapes.
...
An advanced density-based clustering approach.
...
Dimensionality reduction transforms high-dimensional data into fewer dimensions while preserving useful information.
...
Used for visual exploration of high-dimensional datasets.
...
Place the generated pipeline image inside the `assets/` directory:
